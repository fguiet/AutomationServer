	...
	public:
	    /*#if defined (__AVR_ATmega168__)
		   #define SLEEP_MODE_EXT_STANDBY SLEEP_MODE_STANDBY
			...
			#if defined (__AVR_ATmega328P__) || defined (__AVR_ATmega168__) || defined (__AVR_ATmega168PA__) || defined (__AVR_ATmega168P__)
			...
			#else
				#error "Please ensure chosen MCU is either 168, 168P, 168PA, 328P, 32U4, 2560 or 256RFR2."
			#endif
